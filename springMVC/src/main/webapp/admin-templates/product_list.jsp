...
<%--                <input id="c3" value="${m.id}">--%>
    ...
    <td width="10%" bgcolor="#FFFFFF" class="STYLE6" style="text-align:center" id="up"><a href="/pp/update1/${m.id}">修改</a><a href="/pp/delete/${m.id}">删除</a>  <a href="/pp/huifu/${m.id}">恢复</a></td>
            </tr>
            </c:forEach>
        </table>
        </table></td>
